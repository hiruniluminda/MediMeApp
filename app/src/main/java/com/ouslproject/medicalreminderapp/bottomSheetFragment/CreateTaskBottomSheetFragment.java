package com.ouslproject.medicalreminderapp.bottomSheetFragment;
...
//adding a new task and set a reminder for the task
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, MainActivity3 activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
...
//set time
    ...
    public boolean validateFields() {
        if(addTaskTitle.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Please enter a valid medication", Toast.LENGTH_SHORT).show();
            return false;
        }
            ...
            Toast.makeText(activity, "Please enter medication type", Toast.LENGTH_SHORT).show();
            return false;
        }
        else {
            return true;
    ...
    private void createTask() {
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(getActivity(), "Your medication is been added", Toast.LENGTH_SHORT).show();
                dismiss();
