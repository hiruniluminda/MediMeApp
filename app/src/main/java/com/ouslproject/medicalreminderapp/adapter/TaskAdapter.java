package com.ouslproject.medicalreminderapp.adapter;
...
//view popup boxes
//for binding the tasks to their corresponding views in the RecyclerView
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public TaskAdapter(MainActivity3 context, List<Task> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
        this.context = context;
        this.taskList = taskList;
        this.setRefreshListener = setRefreshListener;
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
// new view holder to represent a task
//inflates the layout for each item in the RecyclerView and returns a new TaskViewHolder instance that holds a reference to the inflated view
    @NonNull
    @Override
...
//display the data
// gets the task at the current position and sets the corresponding view's text values with the task's data
    @Override
...
//show popup masseges with options to delete, update, or mark a task as complete
    ...
    //shows a dialog to confirm completed task
...
//shows a dialog to confirm deleted task
...
//removes a task from the list of tasks(updates the RecyclerView)
